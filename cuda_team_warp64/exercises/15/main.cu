...
int main(int argc, char **argv)
{
    ...
    // get tau
    float LAMBDA;
    bool retVal = getParam("lambda", LAMBDA, argc, argv);
    if (!retVal) {
    ...
    // GPU version
    inpainting_EL_RBSOR(imgIn, imgMask, imgOut, dim3(w, h, 0), nc, make_float3(0, 1, 0), make_float3(0.5, 0.5, 0.5), EPSILON, LAMBDA, THETA, steps, diffType);
